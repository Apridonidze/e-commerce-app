        ...
        try {
            ...
            if(response.status === 200){ //handling 200 status code response
                ...
                setCartIds(prev => {
                    ...
                    return [...prev, { id: user.id, product_id: productId, amount: amount, category : toggleAddToCart.product?.category, description : toggleAddToCart.product?.description, title : toggleAddToCart.product?.title , price: toggleAddToCart.product?.price , sales_price : toggleAddToCart.product?.sales_price , subcategory : toggleAddToCart.product?.subcategory , images : toggleAddToCart.product?.images  }]; //else pushing into array
