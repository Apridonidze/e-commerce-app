...
create table reports (id int , report_id int primary key, type enum("product", "webapp" , "delivery"), content varchar(255), foreign key reports(id) references users(id))