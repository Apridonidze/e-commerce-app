...
const DeleteReport = ({ setToggleDeleteReport, toggleDeleteReport, setReports }) => { //importing props from parent component (AdminDashbaord.jsx)
    ...
    console.log(toggleDeleteReport.reportDetails)    

    return(
        <div className="manage-report-container py-3 px-4 mx-auto w-100" style={{zIndex : 999}}>
            ...
            <div className="manage-report-main">
                <h4>Target Report : </h4>
                
                {/* add targeted report hjere */}
            </div>

            <div className="manage-report-bottom">
                <h4>Reason of report deletion</h4>
                <div className="select row gap-2">
            ...
            <span className="warning mt-1">*This reason will be logged in the system and sent to reporter via automated mail sender.</span>
