...
create table cart (id int, product_id int , status enum("none" , "pending" , "delivered") ,foreign key (id) references users(id) , foreign key (product_id) references products(products_id));
