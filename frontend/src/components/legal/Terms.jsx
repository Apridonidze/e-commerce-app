const Terms = () => {
    return(
        <div className="terms-container">
            ...
            <p>Welcome to <strong>E Commerce App</strong>. These Terms of Service govern your use of our platform. By creating an account or using the platform, you agree to these terms.</p>
