...
async function add(req, res) {
    ...
    const Schema = z.object({
        ...
        targetAddress: z.coerce.number().min(0).max(99999),
    ...
    const validateParamsResponse = validateParams({itemsIds : data.itemsIds, targetAddress : data.targetAddress, totalPrice: Number(data.totalPrice)}); //passing data to validator funciton 
