        ...
        <div className="card-holder-container">
            ...
            <div className="card-container p-3 rounded-2">
                <div className="card-container-header">
                    ...
                    <span className="cardIcon">{!cardDetails?.brand ? '' :cardDetails?.brand == 'visa' ? <i class="fa-brands fa-cc-visa"></i> : cardDetails?.brand == 'mastercard' ? <i class="fa-brands fa-cc-mastercard"></i> : <i class="fa-regular fa-credit-card"></i>}</span>
                </div>
